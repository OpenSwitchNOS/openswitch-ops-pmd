...
typedef struct {
        unsigned char temp_high_alarm_msb;
        unsigned char temp_high_alarm_lsb;

        unsigned char temp_low_alarm_msb;
        unsigned char temp_low_alarm_lsb;

        unsigned char temp_high_warning_msb;
        unsigned char temp_high_warning_lsb;

        unsigned char temp_low_warning_msb;
...
typedef struct {
    ...
    unsigned char temp_msb; // byte 22
